...
export default function Event() {
    return (
        <div id="about" className="w-[90%] mx-auto mb-[60px] flex">
            <div className="block w-[50%] text-center sm:pt-[5%]">
                ...
                <p className={`text-black text-sm sm:text-lg text-justify w-[70%] pt-[30px] mx-auto sm:leading-6 ${poppins.className}`}>Ablaze Conference is the annual convention of the Xpression House, a powerful retreat where believers gather to be rekindled in the Word and refreshed in God&apos;s presence.</p>
                <p className={`text-black text-sm sm:text-lg text-justify w-[70%] pt-[30px] mx-auto sm:leading-6 ${poppins.className}`}>From October 8th to 12th 2025, hearts will be set ablaze under the theme DOMINION ACTIVATED.</p>
                <p className={`text-black text-sm sm:text-lg text-justify w-[70%] pt-[30px] mx-auto sm:leading-6 ${poppins.className}`}>An encounter that ignites purpose, Ablaze is for you!</p>

    ...
    return (
        <div id="about" className="h-[60vh] sm:ml-[60px] mb-[60px] flex">
            <div className="block w-[50%] text-center sm:pt-[100px]">
                ...
                <p className="text-black text-sm sm:text-xl text-justify w-[70%] mx-auto font-happy-times">From October 8th to 12th 2025, hearts will be set ablaze under the theme DOMINION ACTIVATED.</p>
                <p className="text-black text-sm sm:text-xl text-justify w-[70%] mx-auto font-happy-times">An encounter that ignites purpose, Ablaze is for you!</p>
            ...
            <div className="relative h-[200px] sm:h-[400px] mt-[70px] sm:mt-[50px] mr-[30px] sm:mr-[150px] bg-cover bg-center block w-[50%]" style={{ backgroundImage: `url(${ablaze.src})` }}>
            </div>
        </div>
    )
}
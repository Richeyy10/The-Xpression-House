    ...
    return (
        <div id="about" className="w-[90%] mx-auto mb-[60px] block md:flex">
            <div className="block md:w-[50%] text-center sm:pt-[5%]">
                ...
                <p className={`text-white text-sm sm:text-lg text-justify w-[70%] pt-[20px] md:pt-[30px] mx-auto sm:leading-10 ${poppins.className}`}>Ablaze Conference is the annual convention of the Xpression House, a powerful retreat where believers gather to be rekindled in the Word and refreshed in God&apos;s presence.</p>
                <p className={`text-white text-sm sm:text-lg text-justify w-[70%] md:pt-[0px] mx-auto sm:leading-10 ${poppins.className}`}>From October 8th to 12th 2025, hearts will be set ablaze under the theme DOMINION ACTIVATED.</p>
                <p className={`text-white text-sm sm:text-lg text-justify w-[70%] md:pt-[0px] mx-auto sm:leading-10 ${poppins.className}`}>An encounter that ignites purpose, Ablaze is for you!</p>

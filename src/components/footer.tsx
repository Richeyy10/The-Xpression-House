...
export default function Footer() {
    ...
    return(
        <div id="footer" className="pt-20 bg-[#37C500]">
            <div className="flex mr-[30px] md:mr-[150px] ml-[30px] md:ml-[150px] gap-8 h-[45vh]">
                <div className="block w-[25%]">
                    <h1 className="text-white text-md md:text-2xl font-bold">Quick Links</h1>
                ...
                <div className="block w-[25%]">
                    <h1 className="text-white text-md md:text-2xl font-bold">Next Steps</h1>
                    <ul className="mt-6 space-y-2 md:space-y-4 text-sm md:text-md text-white">
                        <li>Sermons</li>
                ...
                <div className="block w-[25%]">
                    <h1 className="text-white text-md md:text-2xl font-bold">Service Time</h1>
                    <ul className="mt-6 space-y-2 md:space-y-4 text-sm md:text-md text-white">
                        <li>Sundays - 9 AM</li>
                ...
                <div className="block w-[25%]">
                    <h1 className="text-white text-md md:text-2xl font-bold">Join Our Mailing List</h1>
                    <form className="mt-6 space-y-2 md:space-y-4 text-sm md:text-md text-white">
                        ...
                        <button type="submit" className="border-2 w-[100px] md:w-[200px] bg-white text-[#37C500] rounded-2xl my-[10px] hover:bg-[#37C500] hover:text-white">Subscribe</button>
                    </form>
                </div>
            </div>

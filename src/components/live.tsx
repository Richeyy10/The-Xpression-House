    ...
    return (
        <div className="w-[90%] mx-auto md:flex mt-[40px] mb-[60px]">
            ...
            <div className="block md:w-[50%] text-center">
                <h1 className={`text-black text-center text-xl md:text-2xl pt-[8%] md:pb-[40px] font-bold ${geoslab.className}`}>Watch Our Services Live</h1>
                ...
                <p className={`text-md md:text-xl text-black text-justify w-[80%] md:pt-[20px] md:pt-2 mx-auto leading-8 ${poppins.className}`}>Can&apos;t make it in person? Stream online from anywhere.</p>

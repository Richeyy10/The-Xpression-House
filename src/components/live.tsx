...
export default function Live() {
    return (
        <div className="w-[90%] mx-auto flex mt-[40px] mb-[60px]">
            <div className="w-[50%] ml-[0px] pt-4">
                <div className="flex justify-center">
                    <Youtube videoId="cdK6N1bNySA" title="ABLAZE 2025 || DAY 4 || GRAND FINALE || WORD SESSION II" />
                </div>
            </div>
            <div className="block w-[50%] text-center">
                <h1 className={`text-black text-center text-xl md:text-2xl pt-[8%] pb-[40px] font-bold ${geoslab.className}`}>Watch Our Services Live</h1>

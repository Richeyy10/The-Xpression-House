...
export default function Moments() {
    ...
    return(
        <>
            <div id="moment" className="h-[180vh] md:h-[120vh] text-center">
                ...
                <button className="font-happy-times mt-[10px] text-1xl rounded-3xl bg-transparent border-2 text-[#37C500] w-[150px] md:w-[170px] h-[40px] md:h-[50px] hover:bg-[#37C500] hover:text-white">Explore Our Gallery</button>
            </div>
        </>
    )
}
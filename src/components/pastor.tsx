    ...
    return(
        <>
            <div id="pastor" className="flex mb-[40px]">
                ...
                <div className="block bg-[#624639] h-[750px] text-center w-[50%] mr-[30px] sm:mr-[150px]">
                    <h1 className="text-white text-center text-xl sm:text-2xl pt-[60px] font-bold">MEET OUR LEAD PASTOR</h1>

...
export default function Pastor() {
    return(
        <>
            <div id="pastor" className="md:w-[85%] mx-auto md:flex md:mb-[40px]">
                <div className="relative h-[500px] md:h-[750px] bg-cover bg-center block md:w-[50%]" style={{ backgroundImage: `url(${pastor.src})` }}>
                </div>
                {/* <div className="w-[50%]">
